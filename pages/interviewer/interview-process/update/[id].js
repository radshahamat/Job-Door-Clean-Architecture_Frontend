  ...
  async function fetchdata() {
    try {
      const response = await axios.get(
        process.env.NEXT_PUBLIC_api_root + 'interview-process/' + id,
        {
  ...
  return (
    <>
      <Layout>
        ...
        <div className='w-full mx-auto max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700'>
          <form onSubmit={handleSubmit(onSubmit)} class="max-w-sm mx-auto">
            ...
            <div class="mb-5">
              ...
              <input
                type="number" defaultValue={data?.job_provider_id} placeholder="job_provider_id" {...register("job_provider_id", { required: { value: true, message: "job_provider_id is required" } })}
            ...
            <div class="mb-5">
              ...
              <input
                type="number" defaultValue={data?.job_seeker_id} placeholder="job_seeker_id" {...register("job_seeker_id", { required: { value: true, message: "job_seeker_id is required" } })}
                className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
              />
              <p class="mt-2 text-sm text-red-600 dark:text-red-500">
            ...
            <div class="mb-5">
              ...
              <input
                type="date" defaultValue={data?.date?.substring(0, 10)} placeholder="date" {...register("date", { required: { value: true, message: "date is required" } })}
                className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
              />
              <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                {errors?.date?.message}
            ...
            <div class="mb-5">
              ...
              <input
                type="text" defaultValue={data?.venue} placeholder="venue" {...register("venue", { required: { value: true, message: "venue is required" }, pattern: { value: /[A-Za-z]+$/, message: "Vanue name can not contain white space" } })}
                className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
              />
              <p class="mt-2 text-sm text-red-600 dark:text-red-500">
            ...
            <div class="mb-5">
              ...
              <input
                type="number" defaultValue={data?.interview_steps} placeholder="interview_steps" {...register("interview_steps", { required: { value: true, message: "interview_steps is required" } })}
                className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
              />
              <p class="mt-2 text-sm text-red-600 dark:text-red-500">
            ...
            <div class="mb-5">
              ...
              <input
                type="text" defaultValue={data?.interview_steps} placeholder="interview_type" {...register("interview_type", { required: { value: true, message: "interview_type is required" } })}
                className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
              />
              <p class="mt-2 text-sm text-red-600 dark:text-red-500">
        ...
        <input
          defaultValue={data?.job_provider_id} type="number" placeholder="job_provider_id"
          {...register("job_provider_id", { required: { value: true, message: "job_provider_id is required" } })}
        />
        {errors?.job_provider_id?.message}<br />

        <label htmlFor='job_seeker_id'>job_seeker_id</label>
        <input
          defaultValue={data?.job_provider_id} type="number" placeholder="job_seeker_id"
          {...register("job_seeker_id", { required: { value: true, message: "job_seeker_id is required" } })}
        />
        {errors?.job_seeker_id?.message}<br />

        <label htmlFor='date'>date</label>
        <input
          defaultValue={data?.date?.substring(0, 10)} type="date" placeholder="date"
        ...
        <input
          defaultValue={data?.venue} type="text" placeholder="venue"
        ...
        <input
          defaultValue={data?.interview_steps} type="number" placeholder="interview_steps"
          {...register("interview_steps", { required: { value: true, message: "interview_steps is required" } })}
        />
        {errors?.interview_steps?.message}<br />

        <label htmlFor='interview_type'>interview_type</label>
        <input
          defaultValue={data?.interview_type} type="text" placeholder="interview_type"
          {...register("interview_type", { required: { value: true, message: "interview_type is required" } })}
        />
        {errors?.interview_type?.message}<br />

        <input
          defaultValue={data?.interviewer} type="hidden" value={1} placeholder="interviewer"
          {...register("interviewer", { required: { value: true, message: "interviewer is required" } })}
        />
